...
FROM read_json_auto('%s', format='newline_delimited')`, jsonlFilePath),
		...
		//            sqlColumn: "struct_array_field.struct_string_field",
		//        },
		//        wantQuery: fmt.Sprintf(`SELECT
		//    struct_pack(
		//        struct_string_field := StructArrayField.StructStringField::VARCHAR,
		//        struct_int_field := StructArrayField.StructIntField::INTEGER
